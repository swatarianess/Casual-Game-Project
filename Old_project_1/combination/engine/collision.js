/**
 * Checks for a collision of two objects. Moves objectA if side is true.
 * @param objectA The object that needs to move.
 * @param objectB The object that needs to block.
 * @param side If true, makes return a string, and moves objectA.
 * @returns {*} String if side is true, otherwise boolean.
 */
